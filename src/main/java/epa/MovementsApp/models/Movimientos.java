...
public class Movimientos
{
    ...
    public Movimientos(String id, LocalDateTime fecha, String idProducto, TipoMovimiento tipo, Integer cantidad, Integer existenciaInicial, Integer existenciaFinal, BigDecimal costo, BigDecimal precio) {
        this.id = id;
        this.fecha = fecha;
