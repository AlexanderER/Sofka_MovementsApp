...
@Service
public class ListarMovimientosPaginadoUseCaseImp implements ListarMovimientosPaginadoUseCase
{
    //------------------------------------------------------------------------- (Inyeccion de Dependencias)
    private MovimientoRepository repositorio;

    public ListarMovimientosPaginadoUseCaseImp(MovimientoRepository repositorio)
    {
    ...
    @Override
    public Flux<MovimientosDTO> apply(int pagina, int tamanoPagina)
    {
