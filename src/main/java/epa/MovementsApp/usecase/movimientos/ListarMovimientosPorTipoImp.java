...
@Service
public class ListarMovimientosPorTipoImp implements ListarMovimientosPorString
{
    //------------------------------------------------------------------------- (Inyeccion de Dependencias)
    private MovimientoRepository repositorio;

    public ListarMovimientosPorTipoImp(MovimientoRepository repositorio)
    {
    ...
    {
        return repositorio.findAllByTipo(valorBuscado)
